...
s59.grove.dist <- 176
s73.grove.dist <- 1470
ora.df$grove_dist <- c(rep(s51.grove.dist, 602),
                       rep(s21.grove.dist, 301),
                       rep(s73.grove.dist, 301),
                       rep(s35.grove.dist, 301),
                       rep(s59.grove.dist, 602))

# We have 301 rows per region
# (in the order NE, MA, SE, MW, DS, NW, SW)
...
# assumptions, where P3->S21, P2->S35, P3->S51, P5->S59,
# P9->S73. We'll ship raw ORA from TEX->P2, CAL->P5, FLA->P3,
# FLA->P9.
