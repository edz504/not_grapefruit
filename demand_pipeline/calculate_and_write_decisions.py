...
roj = pd.read_csv('profit_csvs/roj_futures_max_profit_adj.csv')
# fcoj = pd.read_csv('profit_csvs/fcoj_fixed_quantity.csv')
fcoj = pd.read_csv('profit_csvs/fcoj_futures_max_profit_adj.csv')
...
Range('shipping_manufacturing', 'C19:J19').value = [100, 0, 100, 0, 100, 0, 100, 0]
