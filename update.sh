...
Rscript find_optimal_prices_FCOJ_ROJ.R 0.894719309

echo "Adjusting FCOJ, ROJ prices..."
Rscript adjust_optimal_to_constraint_FCOJ_ROJ.R 0.95103434 136000

echo "Writing initial decisions..."
python calculate_and_write_decisions.py 2019